  ...
  return (
    <div className="w-full h-screen ">
      ...
      <div className="w-full absolute top-0 h-full flex flex-col text-white ">
        <div className="m-10 ml-5 mr-5 md:m-16 items-center justify-between flex border-[0.8px] rounded-full ">
          <h1
            className="ml-4"
        ...
        <div className=" text-center md:mt-6 p-6 mt-20 ">
          <h1
            className="  text-4xl py-4 md:text-7xl leading-9 md:leading-16"
          ...
          <p
            className="mt-2 mb-4 md:text-xl"
            style={{ fontFamily: '"Inter", sans-serif' }}
          >
        ...
        {/* <ul className="flex  md:hidden justify-between mt-auto m-6" style={{ fontFamily: '"Inter", sans-serif' }}>
            <li>Home</li>
            <li>Menu</li>
            <li>About</li>
            <li>Contact</li>
